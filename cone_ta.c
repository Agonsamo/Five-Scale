...
{  
 ...
 /******************************** 2  ***********************************/
    ...
    else if (out_p->vza > 0 && out_p->vza <= in_p.ALPHA)      /*Equation (12) and (13)*/
    {   
 ...
 /*out_p->V= PI*in_p.R*(in_p.Hb+out_p->Hc/3.); */    /*commented by Ting*/

 out_p->V= PI*in_p.R*in_p.R*(in_p.Hb+out_p->Hc/3.);    // Added by Ting
}    
